# gshop
  ...
  这个项目是基于vue.js的外卖项目，该项目使用 vue-cli 脚手架初始化 Vue.js 项目，使用 vue-router 开发的单页面应用，利用axios与后端进行数据交互，使用 vuex 管理应用组件状态，项目中是引入better-scroll和vue-lazyload库实现页面滑动效果、图片惰加载。
